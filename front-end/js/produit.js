    ...
    .then(jsonProduct => {
        ...
        let affichage = "";
            affichage += `<div class="img-container-produit">
                        ...
                        <select name="lentille-type" id="input1"></select></p>
            ...
            for (let _lenses of jsonProduct.lenses){
                console.log(_lenses)
                document.querySelector('#input1').innerHTML += `<option value="35mm">${_lenses}</option>`;
            };
        }))